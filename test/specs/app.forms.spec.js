...
describe("Interaction in Forms Screen", () => {
  ...
  it("should validate picker element is working", async () => {
    ...
    expect(NativeDropDown.checkOptionSelectedIndex(data.dropdown_options, optionSelectedText)).toEqual(optionSelected);
    expect(dropDownOptionsTextList).toContain(optionSelectedText);
  });
